...
class PostTransformer extends Transformer 
{
    ...
    public function transform($data) 
    {
        return [
            ...
            'videoImg'      => ($data['is_image'] == 1 && $data['image']) ? URL::to('/').'/uploads/users/video-thumbnail.png/' : '',
    ...
    public function postListWithLike($posts)
    {
        ...
        foreach($posts as $post)
        {
            $response[$sr] = [  
                ...
                'videoImg'          => ($post->is_image == 0 && $post->image) ? URL::to('/').'/uploads/users/video-thumbnail.png/' : '',
